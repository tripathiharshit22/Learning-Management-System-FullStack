  ...
  return courseData ? (
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-20 pt-10 text-left">
        <div className="absolute top-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b rgb(255 255 255 / 70%)"></div>
        ...
        <div className="max-w-xl z-10 text-gray-500">
          ...
          <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
            ...
            <p className='text-black'>({courseData.courseRatings.length} {courseData.courseRatings.length > 1 ? 'ratings' : 'rating'})</p>

            <p>{courseData.enrolledStudents.length} {courseData.enrolledStudents.length > 1 ? 'students' : 'student'}</p>
          </div>

          <p className='text-sm'>Course by <span className='text-black underline'>{courseData.educator.name}</span></p>
          ...
          <div className="p-5">
            <div className="flex items-center gap-2">
              ...
              <p className="text-red-500">
                <span className="font-medium">Few days</span> left at this price!
              </p>
            </div>
            ...
            <button onClick={enrollCourse} className="md:mt-6 mt-4 w-full py-3 rounded-3xl bg-black text-white font-medium">
