    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        ...
        <div>
          ...
          <div className="flex justify-center items-center bg-black text-white p-2 rounded-3xl cursor-pointer" onClick={() => handleChapter('add')}>
            + Add Chapter
          </div>
          ...
          {showPopup && (
            <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
              <div className="bg-white text-gray-700 p-4 rounded relative w-full max-w-80">
                ...
                <button type='button' className="w-full bg-black text-white px-4 py-2 rounded-3xl" onClick={addLecture}>Add</button>
        ...
        <button type="submit" className='bg-black text-white w-max py-2.5 px-8 rounded-3xl my-4'>
          ADD
        </button>
      </form>
    </div>
